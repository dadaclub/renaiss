...
// 시작 화면 배경 — 카드가 위에서 아래로 계속 비처럼 떨어진다 (왼쪽 %, 낙하 시간, 시작 지연, 회전 방향/양, 이미지를 카드마다 다르게)
const FALLING_CARDS = [
  { left: 4, duration: 5.2, delay: 0, spin: 360, src: CARD_SRC },
  { left: 16, duration: 6.4, delay: 1.1, spin: -360, src: CARD2_SRC },
  { left: 29, duration: 4.8, delay: 2.3, spin: 360, src: CARD_SRC },
  { left: 43, duration: 7.1, delay: 0.6, spin: -320, src: CARD2_SRC },
  { left: 57, duration: 5.6, delay: 1.8, spin: 340, src: CARD_SRC },
  { left: 70, duration: 6.9, delay: 0.2, spin: -360, src: CARD2_SRC },
  { left: 83, duration: 5.0, delay: 2.6, spin: 300, src: CARD_SRC },
  { left: 93, duration: 6.2, delay: 1.4, spin: -340, src: CARD2_SRC },
];
